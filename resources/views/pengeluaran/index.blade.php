    ...
    <div class="col-lg-12">
        <div class="box">
            <div class="box-header with-border">
                ...
                <a href="{{ route('pengeluaran.export_pdf', [$tanggalAwal, $tanggalAkhir]) }}" target="_blank" class="btn btn-success btn-xs btn-flat"><i class="fa fa-file-excel-o"></i> Export PDF</a>
            </div>
